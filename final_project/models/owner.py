...
class realowner(models.Model):
    ...
    # properties_name_ids =  fields.One2many('real.estate','owner_info', string='Owned Property')

    #Many to Many Relationship With the RealEstate
    properties_name_ids =  fields.Many2many('real.estate','owner_info', string='Owned Property')
    
    ##Email constraints for Owners to Ensure Emails Uniqueness. 
